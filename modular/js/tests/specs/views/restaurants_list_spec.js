define( 
  ...
  function( RestaurantsCollection, RestaurantsList, sinon) {

    return describe( "Restaurants View" , function() {
      ...
      beforeEach( function() {
        ...
        this.restaurants_collection = new RestaurantsCollection( restaurants_data );
        this.restaurants_view = new RestaurantsList ({
      ...
      it( "should be defined", function() {
        expect( RestaurantsList ).toBeDefined();
      });
